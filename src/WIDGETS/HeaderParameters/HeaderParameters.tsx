...
import ReloadImg from '../../ASSETS/free-icon-rotate-left-circular-arrow-interface-symbol-32418.png'
...
const HeaderParameters: FC = () => {
	...
	return (
		<aside className={styles.parameters}>
			...
			}} dopClass={styles.reloadBTN}><img src={ReloadImg} alt='' className={styles.realodIMG}/></HeaderButton>
			<HeaderButton onclick={() => {
